...
<a href="index.html" class="logo logo-light">
    <span class="logo-lg">
        <img src="../assets/images/logo_cssc.png" alt="logo" style="height: 80px; width: auto;">
    </span>
    <span class="logo-sm">
        <img src="../assets/images/logo-sm.png" alt="small logo" style="height: 60px; width: auto;">
    </span>
</a>
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarEcommerce">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="apps-ecommerce-products.html">Anadir Estudiantes</a>
                                </li>
                                <li>
                                    <a href="apps-ecommerce-products-details.html">Historial de Estudiantes</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarEmail">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="apps-email-inbox.html">Anadir libros</a>
                                </li>
                                <li>
                                    <a href="apps-email-read.html">Historial de Libros</a>
                                </li>
                                <li>
                                    <a href="apps-email-read.html">Libros Disponibles</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarProjects">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="apps-projects-list.html">Realizar prestamo de libros</a>
                                </li>
                                <li>
                                    <a href="apps-projects-details.html">Historial prestamos</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                ...
                <div class="container-fluid">
                                ...
                                <div class="col-sm-6">
                                    <div class="card widget-flat">
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Libros</h5>
                                ...
                                <div class="col-sm-6">
                                    <div class="card widget-flat">
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-muted fw-normal mt-0" title="Number of Orders">Estudiantes</h5>
                                ...
                                <div class="col-sm-6">
                                    <div class="card widget-flat">
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-muted fw-normal mt-0" title="Average Revenue">Prestamos</h5>
                        ...
                        <div class="col-xl-7 col-lg-6">
                            <div class="card card-h-100">
                                <div class="d-flex card-header justify-content-between align-items-center">
                                    <h4 class="header-title">Estadisticas de libros mas solicitados</h4>
                                    <div class="dropdown">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-12 order-lg-2 order-xl-1">
                            <div class="card">
                                <div class="d-flex card-header justify-content-between align-items-center">
                                    <h4 class="header-title">Top libros prestados</h4>
                        ...
                        <div class="col-xl-3 col-lg-6 order-lg-1">
                            <div class="card">
                                <div class="d-flex card-header justify-content-between align-items-center">
                                    <h4 class="header-title">Prestamos Recientes</h4>
                                    <div class="dropdown">
                                        <a href="#" class="dropdown-toggle arrow-none card-drop" data-bs-toggle="dropdown" aria-expanded="false">
                                            <i class="mdi mdi-dots-vertical"></i>
                                        </a>
