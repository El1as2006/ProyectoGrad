...
if (!($conn instanceof PDO)) {
    die("Error crítico: conexión no válida. Revisa 'conexion.php'.");
}

// 3. Consulta SQL para obtener libros activos
$query = "SELECT id_book, book_name, image_cover, category, description, author, estado FROM libros WHERE estado = '1'";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Listado de Libros</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="uploadbook.php" class="btn btn-danger mb-3">
                                <i class="mdi mdi-plus-circle me-2"></i>Registrar Libro
                            </a>
                                    ...
                                    <tbody>
                                        <?php if ($num_books > 0): ?>
                                            <?php foreach ($books as $row): ?>
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" class="form-check-input" id="book-<?php echo $row['id_book']; ?>">
                                                    </td>
                                                    <td>
                                                        <img src="<?php echo htmlspecialchars($row['image_cover']); ?>" alt="cover" class="rounded me-2" height="48" />
                                                        <span><?php echo htmlspecialchars($row['book_name']); ?></span>
                                                    </td>
                                                    <td><?php echo htmlspecialchars($row['category']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['description']); ?></td>
                                                    <td><?php echo htmlspecialchars($row['author']); ?></td>
                                                    <td>
                                                        <span class="badge bg-<?php echo ($row['estado'] == '1') ? 'success' : 'secondary'; ?>">
